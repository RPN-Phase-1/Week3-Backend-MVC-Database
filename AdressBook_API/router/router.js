...
router.post("/contactGroup", contactGroupController.createGroupsContact);
router.put("/contactGroup/:id", contactGroupController.updateGroupsContact);
router.delete("/contactGroup/:id", contactGroupController.deleteGroupsContact);

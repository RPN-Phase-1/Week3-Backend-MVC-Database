...
class Group {
    ...
    static read(){
        return new Promise((resolve,reject)=>{
                let showGroupsQuery = `SELECT groupId AS "ID GRUP",groupName AS "Nama Grup", name AS "Nama Kontak", Contact.id AS "ID Kontak", GroupContact.id AS "ID Group Kontak" FROM (Groups FULL JOIN GroupContact ON Groups.id == GroupContact.groupId) FULL JOIN Contact ON Contact.id == GroupContact.contactId ORDER BY Groups.id`
